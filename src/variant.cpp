...
namespace {
    ...
    Variant* musketeer_variant() {
        ...
        v->pieceToChar = " PNBRQ" + std::string(ARCHBISHOP - QUEEN - 1, ' ') + "AMD" + std::string(CUSTOM_PIECE_1 - AMAZON - 1, ' ') + "LHUSFEC" + std::string(KING - CUSTOM_PIECE_7 - 1, ' ') + "K" + std::string(PIECE_TYPE_NB - KING - 1, ' ')
            + " pnbrq" + std::string(ARCHBISHOP - QUEEN - 1, ' ') + "amd" + std::string(CUSTOM_PIECE_1 - AMAZON - 1, ' ') + "lhusfec" + std::string(KING - QUEEN - 1, ' ') + "k" + std::string(PIECE_TYPE_NB - KING - 1, ' ');
        ...
        v->add_piece(CUSTOM_PIECE_1, 'l', "NB2"); // Leopard
        v->add_piece(CUSTOM_PIECE_2, 'h', "DHAG"); // Hawk
        v->add_piece(CUSTOM_PIECE_3, 'u', "CN"); // Unicorn
        v->add_piece(CUSTOM_PIECE_4, 's', "B2DN"); // Spider
        v->add_piece(CUSTOM_PIECE_5, 'f', "B3DfNbN"); // Fortress
        v->add_piece(CUSTOM_PIECE_6, 'e', "KDA"); // Musketeer Elephant
        v->add_piece(CUSTOM_PIECE_7, 'c', "llNrrNDK"); // Musketeer Cannon
